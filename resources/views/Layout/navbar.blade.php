...
<nav class="fixed top-0 z-20 w-full bg-white shadow-md">
    <div class="flex flex-wrap items-center justify-center max-w-screen-xl p-4 mx-auto gap-4">
        ...
        <h3 class="text-[15px] text-black lg:hidden font-huricane">IsMyGallery</h3>
        <!-- <input type="text" name = "cari" class="px-4 py-1 rounded-full text-left" placeholder ="Search...."> -->
        <!--Profil-->
