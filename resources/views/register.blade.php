        ...
        <div class="max-w-[364px] bg-gray-300 rounded-md shadow-md mx-auto px-6 py-4">
            <form action="/registered" method="post">
                ...
                <div class="flex flex-col">
                    <a href = "/" class="mx-auto text-black text-3xl font-hurricane">IsMyGal</a>
                    <div>
                    ...
                    <button type="submit"
                        class="py-2 px-32 mt-4 text-white rounded-full bg-gray-300 hover:bg-gray-500">Register</button>
                    &nbsp;
